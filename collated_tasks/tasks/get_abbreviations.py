...
if __name__ == "__main__":
    ...
    #print(f"Data file: C:\Users\User\Downloads\archive\mimic-iii-clinical-database-demo-1.4\NOTEEVENTS.csv")

    df = get_df(r'C:\Users\User\Downloads\archive\mimic-iii-clinical-database-demo-1.4\NOTEEVENTS.csv')
